...
1. Να βρεθούν τα συνολικά έσοδα της εταιρίας τον προηγούμενο χρόνο - easy 
2. Να βρεθεί η μέση τιμή των εσόδων του προηγούμενου χρόνου - easy 
3. Να βρεθούν οι μήνες με τα χαμηλότερα και υψηλότερα έσοδα - easy 
4. Να βρεθεί το ποσοστό αύξησης η μείωσης των εσόδων ανα μήνα (απο τον ένα μήνα στον επόμενο) και να αποθηκευτούν σε μια λίστα - hard 
