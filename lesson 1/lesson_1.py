...
question = float(int_num) # τι τιμή θα έχει εδώ ;  

question_2 = str(float_num) # Εδώ ;
...
την συνάρτηση input 
num_1 = input("text to be shown to the user") 
...
supermarket = ['meat' ,  'chocolate' ,'meat' , 'eggs']
...
groceries.remove('meat') # θα διαγράψει και τα 2 meat ; 
...
# πως θα γράφατε αυτή την συνάρτηση με το range ; 
...
1. Να βρεθούν τα συνολικά έσοδα της εταιρίας τον προηγούμενο χρόνο 
2. Να βρεθεί η μέση τιμή των εσόδων του προηγούμενου χρόνου  
3. Να βρεθούν οι μήνες με τα χαμηλότερα και υψηλότερα έσοδα  
4. Να βρεθεί το ποσοστό αύξησης η μείωσης των εσόδων ανα μήνα (απο τον ένα μήνα στον επόμενο) και να αποθηκευτούν σε μια λίστα 
